...
#def temperature(T, p, h, m, c_w, x_ice,season, h_ice, I_export):
...
#    print ' '    
#    print 'first', (1 - world.ice.x_ice) * (world.atmos.Q_sw - world.atmos.Q_lw - world.ocean.Q_turb)
#    print 'Q_ml_ice', world.ice.x_ice * world.ocean.Q_int[:,:,0]
#    print 'Q_trans', world.ocean.Q_trans[:,:,0]
#    print 'q_int', world.ocean.Q_int[:,:,1]
#    print 'x_ice', world.ice.x_ice.shape
#    print 'q_sw', world.atmos.Q_sw.shape
#    print 'q_lw', world.atmos.Q_lw.shape
#    print 'turb', world.ocean.Q_turb.shape
...
def Q_lw(world):#if season==0           if x_ice==0 
...
def Q_horiz(world):
    ...
    Q_int_dia_yx[1:world.dim.n_x, 1:world.dim.n_y,:] = world.ocean.k_t_horiz_tot[0,0,:] * (world.ocean.p[0:world.dim.n_x-1, 1:world.dim.n_y,:] * world.ocean.T[0:world.dim.n_x-1, 1:world.dim.n_y, :] - world.ocean.p[0:world.dim.n_x-1, 1:world.dim.n_y, :] * world.ocean.T[1:world.dim.n_x, 0:world.dim.n_y-1, :]) / world.ocean.h[:]# * 2 ** (0.5)
    ...
    Q_horiz = Q_int_xy + Q_int_dia_tot
